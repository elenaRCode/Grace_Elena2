...
# sample 365 days worth of readings (one per day, with replacement)
pm25_readings <- sample(possible_pm25, size = 365, replace = TRUE)

# make it a data frame - we'll add more columns to it as we go
...
# store it as a factor (the assignment requires this)
